...
// Re-export the Supabase client type for use in services
// This allows services to accept both standard and server clients
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type SupabaseClient = SupabaseClientBase<Database, "public", any>;
